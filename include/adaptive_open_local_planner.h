...
class AdaptiveOpenLocalPlanner
{
public:
    // Constructor
    AdaptiveOpenLocalPlanner();

    // Destructor
    virtual ~AdaptiveOpenLocalPlanner(){};
...
private:
    ...
    void globalPathCallback(const adaptive_open_local_planner::WaypointArray::ConstPtr &global_path_msg);
